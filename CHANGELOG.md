...
- Comentário de versão no topo do `server.py`, parado na v2.44.0.
...
### Corrigido
- **Ao preencher a data de publicação do Aviso de Dispensa, a etapa inteira era redesenhada.** O campo em uso sumia por um instante e podia engolir o próximo clique ou digitação. Agora só o campo de encerramento e o alerta de prazo mínimo são atualizados, sem redesenhar o resto.
...
- **Mapa de Preços passa a numerar as folhas.** Era o único documento gerado sem "Folha N" no rodapé — justamente um dos que mais crescem em página, porque lista uma linha por proposta. Passou a usar o mesmo bloco de impressão dos demais.
...
### Alterado
- **Ícones da barra lateral agora são emoji** (📊 Dashboard, 🏢 Fornecedores, 📅 Agenda, 🗑️ Lixeira, 🕘 Auditoria, ⚙️ Configurações), no mesmo estilo do SGEA — substituindo os ícones SVG de linha.
