...
- **Código de autenticidade** no rodapé de todos os documentos gerados
...
| Sistema | Cuida de | |
|---|---|---|
| **SGCD** — Contratação Direta | dispensas de licitação, do pedido ao contrato | **(este)** |
...
> SILVA, T. R. M. **SGCD: sistema de gestão de contratação direta**. Zenodo. https://doi.org/10.5281/zenodo.21314672
