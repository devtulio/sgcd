...
//
// O banco é um diretório temporário novo a cada execução (SGCD_DATA_DIR), como
// nos testes: a captura NUNCA enxerga o sgcd.db real. Isso é o que garante que
...
const dataDir = mkdtempSync(join(tmpdir(), 'sgcd-shots-'));
const port = 3059;   // porta propria: nao conflita com a suite E2E (3050)
